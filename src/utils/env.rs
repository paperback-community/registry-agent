...
pub fn validate() -> Result<(), u8> {
    ...
    println!("Validated the presence and correctness of the following environment variables: REGISTRY_MANAGER_PAT, REGISTRY_MANAGER_REPOSITORY, REGISTRY_MANAGER_BRANCH");
